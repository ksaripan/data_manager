...
from data_manager.writer.formatters.delimited_formatter import CSVDelimitedFormatter
...
class SampleFileWriter(AbstractFileWriter):
    model = SampleModel()
    formatter = CSVDelimitedFormatter()
...
if __name__ == '__main__':
    ...
    with open('./out_csv_sample_file.csv', 'w') as f:
        writer.run(f, data)
